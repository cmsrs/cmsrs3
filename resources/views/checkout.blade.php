      ...
      <div class="container">
        <div class="col">   
          ...
          <div class="row form-group d-flex align-items-center mb-3">
            ...
            <div  class="col-sm-10">
              <input id="email" type="text" name="email" class="@error('email') is-invalid @enderror"   @if (Auth::check()) readonly value="{{ Auth::user()->email }}" @else  value="{{ old('email') }}" @endif>
              @error('email')
          ...
          <div class="row form-group d-flex align-items-center mb-3">
            ...
            <input id="address" type="text" name="address" class="@error('address') is-invalid @enderror" value="{{ old('address') }}">
            @error('address')
                <div class="invalid-feedback"  style="display: block;" >{{ $message }}</div>
            @enderror
            </div>
          ...
          <div class="row form-group d-flex align-items-center mb-3">
            ...
            <input id="country" type="text" name="country" class="@error('country') is-invalid @enderror"  value="{{ old('country') }}" >
            @error('country')
                <div class="invalid-feedback"  style="display: block;" >{{ $message }}</div>
            @enderror
            </div>
          ...
          <div class="row form-group d-flex align-items-center mb-3">
            ...
            <input id="city" type="text" name="city" class="@error('city') is-invalid @enderror"  value="{{ old('city') }}">
            @error('city')
                <div class="invalid-feedback"  style="display: block;" >{{ $message }}</div>
            @enderror
            </div>
          ...
          <div class="row form-group d-flex align-items-center mb-3">
            ...
            <input id="telephone" type="text" name="telephone" class="@error('telephone') is-invalid @enderror"  value="{{ old('telephone') }}">
            @error('telephone')
                <div class="invalid-feedback"  style="display: block;" >{{ $message }}</div>
            @enderror
            </div>
          ...
          <div class="row form-group d-flex align-items-center mb-3">
            ...
            <input id="postcode" type="text" name="postcode" class="@error('postcode') is-invalid @enderror" value="{{ old('postcode') }}">
            @error('postcode')
                <div class="invalid-feedback"  style="display: block;" >{{ $message }}</div>
            @enderror
            </div>
